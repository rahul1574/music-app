...
const element1List = ['apple','Rahul','Harshitha','Ashreya','Mahesh','Navyasri'];
const element2List = ['date','nani@123','Harshitha@123','Ashreya@123','123456789','navya@13112004'];
...
const checkElements = () => {
  ...
  return element1 !== '' && element2 !== '' && element1Index !== -1 && element2Index !== -1 && ((element1Index === 0 && element2Index === 0) || (element1Index===1 && element2Index===1) || (element1Index===2 && element2Index===2)||(element1Index===3 && element2Index===3)||(element1Index===4 && element2Index===4)||(element1Index===5 && element2Index===5));
};
